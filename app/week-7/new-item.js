...
export default function NewItem({ onAddItem }) {
  ...
  return (
    <section className="w-full">
      <article className="mb-2 p-4 border rounded shadow-sm text-black bg-gray-200/50 flex flex-col items-center">
        <h3 className="text-xl font-semibold text-[#035718] mb-3 text-center">Add a New Item</h3>

        <form onSubmit={handleSubmit} className="flex flex-col items-center w-full max-w-sm space-y-4">
          <div className="flex flex-col items-center w-full">
            <label htmlFor="name" className="block mb-1 font-semibold text-center"> Item Name: </label>
            <input
              type="text"
              id="name"
              value={name}
          ...
          <div className="flex flex-col items-center w-full">
            <label htmlFor="quantity" className="block mb-1 font-semibold text-center"> Quantity: </label>
          ...
          <div className="flex flex-col items-center w-full">
            <label htmlFor="category" className="block mb-1 font-semibold text-center"> Category: </label>
